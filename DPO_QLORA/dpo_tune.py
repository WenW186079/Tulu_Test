...
def main(args: FlatArguments):
    ...
    if args.use_qlora:
        ...
        # logger.info(f"Tokenizer size: {len(tokenizer)} tokens")
        ...
        logger.info("Base model loaded with quantization.")
        print('=========base_model========')
        ...
        print(f"Total model params: {base_params + lora_params}")
    ...
    logger.info(f"Model embedding size after loading: {model.get_input_embeddings().weight.shape[0]}")
